...
def distribute_dataset(attackers_ratio, dataset_name, num_peers, num_classes, dd_type = 'IID', classes_per_peer = 1, samples_per_class = 582,
alpha = 1):
    ...
    if dd_type == 'IID':
        ...
        peers_data_dict, attack_label = sample_extreme(attackers_ratio, trainset, num_peers, num_classes, classes_per_peer,
                                                       samples_per_class)
...
def sample_extreme(attackers_ratio, dataset, num_users, num_classes, classes_per_peer, samples_per_class):
    n = len(dataset)
    num_classes = 10
    ...
    num_attackers = (int)(num_users * attackers_ratio)
